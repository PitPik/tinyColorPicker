/*! tiny colorPicker - v1.0.0 2015-02-07 */
...
!function(a,b,c){"use strict";function d(b){return b.value||b.getAttribute("value")||a(b).css("background-color")||"#fff"}function e(a){return a.originalEvent.touches?a.originalEvent.touches[0]:a}function f(b){return a(b.find(r.doRender)[0]||b[0])}function g(b){var c,e=a(this);b?(c=e.offset(),z.$element=f(e),(s||h()).css({left:c.left,top:c.top+e.outerHeight(!0)}).show(r.animationSpeed,function(){z.alphaWidth=a(".cp-alpha",s).width(),z.sliderWidth=a(".cp-xy-slider",s).width(),q.setColor(d(z.$element[0])),n(!0)})):a(s).hide(r.animationSpeed,function(){z.$element.blur(),n(!1)})}function h(){return a("head").append('<style type="text/css">'+(r.css||G)+(r.cssAddon||"")+"</style>"),s=a(F).css({margin:r.margin}).find(".cp-alpha").toggle(!!r.opacity).parent().show(0,function(){D=r.GPU&&""===a(this).css("perspective"),r.buidCallback.call(p,a(this)),t=a(".cp-xy-slider",this),u=a(".cp-xy-cursor",this),v=a(".cp-z-cursor",this),w=a(".cp-alpha",this),x=a(".cp-alpha-cursor",this)}).hide().on("touchstart mousedown pointerdown",".cp-xy-slider,.cp-z-slider,.cp-alpha",i).appendTo(document.body)}function i(b){var c=this.className.replace("cp-","").replace("-","_");b.preventDefault(),z.elementOrigin=a(this).offset(),(c="xy_slider"===c?k:"z_slider"===c?l:m)(b),y.on(C,j).on(B,c)}function j(){y.off(B).off(C)}function k(a){var b=e(a),c=b.pageX-z.elementOrigin.left,d=b.pageY-z.elementOrigin.top;q.setColor({s:c/z.sliderWidth*100,v:100-d/z.sliderWidth*100},"hsv"),E(n)}function l(a){{var b=e(a).pageY-z.elementOrigin.top;q.colors.hsv}q.setColor({h:360-b/z.sliderWidth*360},"hsv"),E(n)}function m(a){var b=e(a).pageX-z.elementOrigin.left,c=b/z.alphaWidth;q.setColor({},"rgb",c>1?1:0>c?0:c),E(n)}function n(a){var b=q.colors,d=b.hueRGB,e=b.RND.rgb,f=b.RND.hsl,g="#222",h="#ddd",i=z.$element,j=i.data("colorMode"),k=1!==b.alpha,l=Math.round(100*b.alpha)/100,m=e.r+", "+e.g+", "+e.b,n="HEX"!==j||k?"rgb"===j||"HEX"===j&&k?k?"rgba("+m+", "+l+")":"rgb("+m+")":"hsl"+(k?"a(":"(")+f.h+", "+f.s+"%, "+f.l+"%"+(k?", "+l:"")+")":"#"+b.HEX,o=b.HUELuminance>.22?g:h,s=b.rgbaMixBlack.luminance>.22?g:h,y=(1-b.hsv.h)*z.sliderWidth,A=b.hsv.s*z.sliderWidth,B=(1-b.hsv.v)*z.sliderWidth,C=l*z.alphaWidth,E=D?"translate3d":"";t.css({backgroundColor:"rgb("+d.r+","+d.g+","+d.b+")"}),u.css({transform:E+"("+A+"px, "+B+"px, 0)",left:D?"":A,top:D?"":B,borderColor:b.RGBLuminance>.22?g:h}),v.css({transform:E+"(0, "+y+"px, 0)",top:D?"":y,borderColor:"transparent "+o}),w.css({backgroundColor:"rgb("+m+")"}),x.css({transform:E+"("+C+"px, 0, 0)",left:D?"":C,borderColor:s+" transparent"}),r.doRender&&i.css({backgroundColor:n,color:b.rgbaMixBGMixCustom.luminance>.22?g:h}),i.val()!==n&&i.val(n),r.renderCallback.call(p,i,"boolean"==typeof a?a:c)}var o,p,q,r,s,t,u,v,w,x,y=a(document),z={},A="",B="touchmove mousemove pointermove",C="touchend mouseup pointerup",D=!1,E=window.requestAnimationFrame||window.webkitRequestAnimationFrame||function(a){a()},F='<div class="cp-color-picker"><div class="cp-z-slider"><div class="cp-z-cursor"></div></div><div class="cp-xy-slider"><div class="cp-white"></div><div class="cp-xy-cursor"></div></div><div class="cp-alpha"><div class="cp-alpha-cursor"></div></div></div>',G=".cp-color-picker{position:absolute;overflow:hidden;padding:6px 6px 0;background-color:#444;color:#bbb;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:400;cursor:default;border-radius:5px}.cp-color-picker>div{position:relative;overflow:hidden}.cp-xy-slider{float:left;height:128px;width:128px;margin-bottom:6px;background:linear-gradient(to right,rgba(255,255,255,1)0,rgba(255,255,255,0)100%)}.cp-white{height:100%;width:100%;background:linear-gradient(to bottom,rgba(0,0,0,0)0,rgba(0,0,0,1)100%)}.cp-xy-cursor{position:absolute;top:0;width:10px;height:10px;margin:-5px;border:1px solid #fff;border-radius:100%;box-sizing:border-box}.cp-z-slider{float:right;margin-left:6px;height:128px;width:20px;background:linear-gradient(to bottom,red 0,#f0f 17%,#00f 33%,#0ff 50%,#0f0 67%,#ff0 83%,red 100%)}.cp-z-cursor{position:absolute;margin-top:-4px;width:100%;border:4px solid #fff;border-color:transparent #fff;box-sizing:border-box}.cp-alpha{clear:both;width:100%;height:16px;margin:6px 0;background:linear-gradient(to right,rgba(68,68,68,1)0,rgba(0,0,0,0)100%)}.cp-alpha-cursor{position:absolute;margin-left:-4px;height:100%;border:4px solid #fff;border-color:#fff transparent;box-sizing:border-box}",H=function(a){q=this.color=new b(a),r=q.options};H.prototype.render=n,H.prototype.toggle=g,a.fn.colorPicker=function(b){var c=function(){};return b=a.extend({animationSpeed:150,GPU:!0,doRender:!0,customBG:"#FFF",opacity:!0,renderCallback:c,buidCallback:c,body:document.body},b),o=o?o.add(this):this,A+=(A?", ":"")+this.selector,this.colorPicker=p||(p=new H(b)),a(b.body).off(".a").on("touchstart.a mousedown.a pointerdown.a",function(b){var c=a(b.target);-1!==a.inArray(c.closest(A)[0],o)||c.closest(s).length||g()}).on("focus.a click.a",A,g).on("change.a",A,function(){q.setColor(this.value),o.colorPicker.render()}),this.each(function(){var c=d(this),e=c.split("("),g=f(a(this));g.data("colorMode",e[1]?e[0].substr(0,3):"HEX").attr("readonly",r.preventFocus),b.doRender&&g.css({"background-color":c,color:function(){return q.setColor(c).rgbaMixBGMixCustom.luminance>.22?"#222":"#ddd"}})})}}(window.jQuery,Colors);
