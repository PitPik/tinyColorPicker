/*! tiny colorPicker - v1.0.0 2015-02-08 */
...
!function(a,b,c){"use strict";function d(b){return b.value||b.getAttribute("value")||a(b).css("background-color")||"#fff"}function e(a){return a.originalEvent.touches?a.originalEvent.touches[0]:a}function f(b){return a(b.find(r.doRender)[0]||b[0])}function g(b){var c,e=a(this);b?(c=e.offset(),s=f(e),(t||h()).css({left:c.left,top:c.top+e.outerHeight(!0)}).show(r.animationSpeed,function(){x._width=x.width(),u._width=u.width(),u._height=u.height(),q.setColor(d(s[0])),n(!0)})):a(t).hide(r.animationSpeed,function(){s.blur(),n(!1)})}function h(){return a("head").append('<style type="text/css">'+(r.css||G)+(r.cssAddon||"")+"</style>"),t=a(F).css({margin:r.margin}).show(0,function(){D=r.GPU&&""===a(this).css("perspective"),r.buidCallback.call(p,a(this)),u=a(".cp-xy-slider",this),v=a(".cp-xy-cursor",this),w=a(".cp-z-cursor",this),x=a(".cp-alpha",this).toggle(!!r.opacity),y=a(".cp-alpha-cursor",this)}).hide().on("touchstart mousedown pointerdown",".cp-xy-slider,.cp-z-slider,.cp-alpha",i).appendTo("body")}function i(b){var c=this.className.replace(/cp-(.*?)(?:\s*|$)/,"$1").replace("-","_");b.preventDefault(),s._offset=a(this).offset(),(c="xy_slider"===c?k:"z_slider"===c?l:m)(b),z.on(C,j).on(B,c)}function j(){z.off(B).off(C)}function k(a){var b=e(a),c=b.pageX-s._offset.left,d=b.pageY-s._offset.top;q.setColor({s:c/u._width*100,v:100-d/u._height*100},"hsv"),E(n)}function l(a){{var b=e(a).pageY-s._offset.top;q.colors.hsv}q.setColor({h:360-b/u._height*360},"hsv"),E(n)}function m(a){var b=e(a).pageX-s._offset.left,c=b/x._width;q.setColor({},"rgb",c>1?1:0>c?0:c),E(n)}function n(a){var b=q.colors,d=b.hueRGB,e=b.RND.rgb,f=b.RND.hsl,g="#222",h="#ddd",i=s.data("colorMode"),j=1!==b.alpha,k=Math.round(100*b.alpha)/100,l=e.r+", "+e.g+", "+e.b,m="HEX"!==i||j?"rgb"===i||"HEX"===i&&j?j?"rgba("+l+", "+k+")":"rgb("+l+")":"hsl"+(j?"a(":"(")+f.h+", "+f.s+"%, "+f.l+"%"+(j?", "+k:"")+")":"#"+b.HEX,n=b.HUELuminance>.22?g:h,o=b.rgbaMixBlack.luminance>.22?g:h,t=(1-b.hsv.h)*u._height,z=b.hsv.s*u._width,A=(1-b.hsv.v)*u._height,B=k*x._width,C=D?"translate3d":"";u.css({backgroundColor:"rgb("+d.r+","+d.g+","+d.b+")"}),v.css({transform:C+"("+z+"px, "+A+"px, 0)",left:D?"":z,top:D?"":A,borderColor:b.RGBLuminance>.22?g:h}),w.css({transform:C+"(0, "+t+"px, 0)",top:D?"":t,borderColor:"transparent "+n}),x.css({backgroundColor:"rgb("+l+")"}),y.css({transform:C+"("+B+"px, 0, 0)",left:D?"":B,borderColor:o+" transparent"}),r.doRender&&s.css({backgroundColor:m,color:b.rgbaMixBGMixCustom.luminance>.22?g:h}),s.val()!==m&&s.val(m),r.renderCallback.call(p,s,"boolean"==typeof a?a:c)}var o,p,q,r,s,t,u,v,w,x,y,z=a(document),A="",B="touchmove mousemove pointermove",C="touchend mouseup pointerup",D=!1,E=window.requestAnimationFrame||window.webkitRequestAnimationFrame||function(a){a()},F='<div class="cp-color-picker"><div class="cp-z-slider"><div class="cp-z-cursor"></div></div><div class="cp-xy-slider"><div class="cp-white"></div><div class="cp-xy-cursor"></div></div><div class="cp-alpha"><div class="cp-alpha-cursor"></div></div></div>',G=".cp-color-picker{position:absolute;overflow:hidden;padding:6px 6px 0;background-color:#444;color:#bbb;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:400;cursor:default;border-radius:5px}.cp-color-picker>div{position:relative;overflow:hidden}.cp-xy-slider{float:left;height:128px;width:128px;margin-bottom:6px;background:linear-gradient(to right,rgba(255,255,255,1)0,rgba(255,255,255,0)100%)}.cp-white{height:100%;width:100%;background:linear-gradient(to bottom,rgba(0,0,0,0)0,rgba(0,0,0,1)100%)}.cp-xy-cursor{position:absolute;top:0;width:10px;height:10px;margin:-5px;border:1px solid #fff;border-radius:100%;box-sizing:border-box}.cp-z-slider{float:right;margin-left:6px;height:128px;width:20px;background:linear-gradient(to bottom,red 0,#f0f 17%,#00f 33%,#0ff 50%,#0f0 67%,#ff0 83%,red 100%)}.cp-z-cursor{position:absolute;margin-top:-4px;width:100%;border:4px solid #fff;border-color:transparent #fff;box-sizing:border-box}.cp-alpha{clear:both;width:100%;height:16px;margin:6px 0;background:linear-gradient(to right,rgba(68,68,68,1)0,rgba(0,0,0,0)100%)}.cp-alpha-cursor{position:absolute;margin-left:-4px;height:100%;border:4px solid #fff;border-color:#fff transparent;box-sizing:border-box}",H=function(a){q=this.color=new b(a),r=q.options};H.prototype={render:n,toggle:g},a.fn.colorPicker=function(b){var c=function(){};return b=a.extend({animationSpeed:150,GPU:!0,doRender:!0,customBG:"#FFF",opacity:!0,renderCallback:c,buidCallback:c,body:document.body},b),o=o?o.add(this):this,A+=(A?", ":"")+this.selector,o.colorPicker=p||(p=new H(b)),a(b.body).off(".a").on("touchstart.a mousedown.a pointerdown.a",function(b){var c=a(b.target);-1!==a.inArray(c.closest(A)[0],o)||c.closest(t).length||g()}).on("focus.a click.a",A,g).on("change.a",A,function(){q.setColor(this.value),o.colorPicker.render()}),this.each(function(){var c=d(this),e=c.split("("),g=f(a(this));g.data("colorMode",e[1]?e[0].substr(0,3):"HEX").attr("readonly",r.preventFocus),b.doRender&&g.css({"background-color":c,color:function(){return q.setColor(c).rgbaMixBGMixCustom.luminance>.22?"#222":"#ddd"}})})}}(window.jQuery,Colors);
