/*! tiny colorPicker - v1.0.0 2015-02-03 */
...
!function(a,b){"use strict";function c(b){return b.value||a(b).css("background-color")||"#fff"}function d(a){return a.originalEvent.touches?a.originalEvent.touches[0]:a}function e(b){var d,e=a(this);b?(d=e.offset(),w.$element=e,o.preventFocus&&b.preventDefault(),(p||f()).css({left:d.left,top:d.top+e.outerHeight(!0)}).show(o.animationSpeed,function(){w.alphaWidth=a(".cp-alpha",p).width(),w.sliderWidth=a(".cp-xy-slider",p).width(),n.setColor(c(e[0])),A(function(){l(!0)})})):a(p).hide(o.animationSpeed,function(){w.$element.blur()})}function f(){return a("head").append('<style type="text/css">'+(o.css||C)+(o.cssAddon||"")+"</style>"),p=a(B).css({margin:o.margin}).find(".cp-alpha").toggle(!!o.opacity).parent().show(0,function(){z=o.GPU&&""===a(this).css("perspective"),o.buidCallback.call(m,a(this)),q=a(".cp-xy-slider",this),r=a(".cp-xy-cursor",this),s=a(".cp-z-cursor",this),t=a(".cp-alpha",this),u=a(".cp-alpha-cursor",this)}).hide().on("touchstart mousedown pointerdown",".cp-xy-slider,.cp-z-slider,.cp-alpha",g).appendTo(document.body)}function g(b){var c=this.className.replace("cp-","").replace("-","_");b.preventDefault(),w.elementOrigin=a(this).offset(),(c="xy_slider"===c?i:"z_slider"===c?j:k)(b),v.on(y,h).on(x,c)}function h(){v.off(x).off(y)}function i(a){var b=d(a),c=b.pageX-w.elementOrigin.left,e=b.pageY-w.elementOrigin.top;n.setColor({s:c/w.sliderWidth*100,v:100-e/w.sliderWidth*100},"hsv"),A(l)}function j(a){{var b=d(a).pageY-w.elementOrigin.top;n.colors.hsv}n.setColor({h:360-b/w.sliderWidth*360},"hsv"),A(l)}function k(a){var b=d(a).pageX-w.elementOrigin.left,c=b/w.alphaWidth;n.setColor({},"rgb",c>1?1:0>c?0:c),A(l)}function l(a){var b=n.colors,c=b.hueRGB,d=b.RND.rgb,e=b.RND.hsl,f="#222",g="#ddd",h=w.$element.data("colorMode"),i=1!==b.alpha,j=Math.round(100*b.alpha)/100,k=d.r+", "+d.g+", "+d.b,l="rgba("+k+", "+j+")",p="HEX"!==h||i?"rgb"===h||"HEX"===h&&i?i?l:"rgb("+k+")":"hsl"+(i?"a(":"(")+e.h+", "+e.s+"%, "+e.l+"%"+(i?", "+j:"")+")":"#"+b.HEX,v=b.HUELuminance>.22?f:g,x=b.rgbaMixBlack.luminance>.22?f:g,y=(1-b.hsv.h)*w.sliderWidth,A=b.hsv.s*w.sliderWidth,B=(1-b.hsv.v)*w.sliderWidth,C=j*w.alphaWidth,D=z?"translate3d":"";q.css({backgroundColor:"rgb("+c.r+","+c.g+","+c.b+")"}),r.css({transform:D+"("+A+"px, "+B+"px, 0)",left:z?0:A,top:z?0:B,borderColor:b.RGBLuminance>.22?f:g}),s.css({transform:D+"(0, "+y+"px, 0)",top:z?0:y,borderColor:"transparent "+v}),t.css({backgroundColor:"rgb("+k+")"}),u.css({transform:D+"("+C+"px, 0, 0)",left:z?0:C,borderColor:x+" transparent"}),o.doRender&&w.$element.css({backgroundColor:l,color:b.rgbaMixBGMixCustom.luminance>.22?f:g}),w.$element.val(p),o.renderCallback.call(m,w.$element,a===!0)}var m,n,o,p,q,r,s,t,u,v=a(document),w={},x="touchmove mousemove pointermove",y="touchend mouseup pointerup",z=!1,A=window.requestAnimationFrame||window.webkitRequestAnimationFrame||function(a){a()},B='<div class="cp-color-picker"><div class="cp-z-slider"><div class="cp-z-cursor"></div></div><div class="cp-xy-slider"><div class="cp-white"></div><div class="cp-xy-cursor"></div></div><div class="cp-alpha"><div class="cp-alpha-cursor"></div></div></div>',C=".cp-color-picker{position:absolute;overflow:hidden;padding:6px 6px 0;background-color:#444;color:#bbb;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:400;cursor:default;border-radius:5px}.cp-color-picker>div{position:relative;overflow:hidden}.cp-xy-slider{float:left;height:128px;width:128px;margin-bottom:6px;background:linear-gradient(to right,rgba(255,255,255,1)0,rgba(255,255,255,0)100%)}.cp-white{height:100%;width:100%;background:linear-gradient(to bottom,rgba(0,0,0,0)0,rgba(0,0,0,1)100%)}.cp-xy-cursor{position:absolute;top:0;width:10px;height:10px;margin:-5px;border:1px solid #fff;border-radius:100%;box-sizing:border-box}.cp-z-slider{float:right;margin-left:6px;height:128px;width:20px;background:linear-gradient(to bottom,red 0,#f0f 17%,#00f 33%,#0ff 50%,#0f0 67%,#ff0 83%,red 100%)}.cp-z-cursor{position:absolute;margin-top:-4px;width:100%;border:4px solid #fff;border-color:transparent #fff;box-sizing:border-box}.cp-alpha{clear:both;width:100%;height:16px;margin:6px 0;background:linear-gradient(to right,rgba(68,68,68,1)0,rgba(0,0,0,0)100%)}.cp-alpha-cursor{position:absolute;margin-left:-4px;height:100%;border:4px solid #fff;border-color:#fff transparent;box-sizing:border-box}",D=function(a){n=this.color=new b(a),o=n.options};D.prototype.render=l,D.prototype.toggle=e,a.fn.colorPicker=function(b){var d=this,f=function(){};return b=a.extend({animationSpeed:150,GPU:!0,doRender:!0,customBG:"#FFF",opacity:!0,renderCallback:f,buidCallback:f},b),m||(m=new D(b),v.on("touchstart mousedown pointerdown",function(b){-1!==a.inArray(b.target,d)||a(b.target).closest(p).length||e()}).on("focus",this.selector,e).on("change",this.selector,function(){n.setColor(this.value),d.colorPicker.render()})),this.colorPicker=m,this.each(function(){var d=c(this),e=d.split("(");a(this).data("colorMode",e[1]?e[0].substr(0,3):"HEX"),b.doRender&&a(this).css({"background-color":d,color:function(){return n.setColor(d).rgbaMixBGMixCustom.luminance>.22?"#222":"#ddd"}})})}}(window.jQuery,Colors);
